...
<head>
    ...
    <title>@yield('title','Anasayfa') - {{$config->title}}</title>
    <!-- Bootstrap core CSS -->
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="{{route('homepage')}}">@if($config->logo!=null)<img width="80" src="{{asset($config->logo)}}">@else{{$config->title}}@endif</a>
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="site-heading">
                    <h1>@yield('title','Ahset Y@zılım')</h1>
                    <span class="subheading">Ahsent Y@zılım</span>
                </div>
            </div>
        </div>
    </div>
