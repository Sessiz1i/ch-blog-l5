        ...
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.page.edit.post',$page->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="{{asset($page->image)}}" class="rounded" width="600">
                    <input type="file" name="image" class="form-control">
                </div>
                <div class="form-group">
                    <label>Sayfa İçerik</label>
                    <textarea id="editor" name="content" class="form-control" rows="7" required>{!! $page->content !!}</textarea>
                </div>
                <div class="form-group">
                    <button type="submit" name="gonder" class="btn btn-primary btn-block">Sayfa Düzenle</button>
                </div>
            </form>
        </div>
    </div>
